...
if (!createObject('modNamespace',array(
    'name' => 'commerce_omise',
    'path' => $componentPath.'/core/components/commerce_omise/',
    'assets_path' => $componentPath.'/assets/components/commerce_omise/',
),'name', false)) {
    echo "Error creating namespace commerce_omise.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_omise.core_path',
    'value' => $componentPath.'/core/components/commerce_omise/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_omise',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_omise.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_omise.assets_path',
    'value' => $componentPath.'/assets/components/commerce_omise/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_omise',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_omise.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_omise/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_omise.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_omise',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_omise.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_omise.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_omise/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_omise/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'DigitalPenguin\\Commerce_Omise\\Modules\\', $modulePath);
